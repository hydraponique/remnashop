...
ntf-channel-join-required = ❇️ Подпишитесь на наш канал, чтобы быть в курсе <b>новостей сервиса, акций и бонусов</b>! После подписки нажмите кнопку «Подтвердить».
ntf-channel-join-required-left = ⚠️ Вы отписались от нашего канала! Подпишитесь, чтобы иметь возможность пользоваться ботом.
ntf-rules-accept-required = ⚠️ Пожалуйста, ознакомьтесь и примите <a href="{ $url }"><b>Правила</b></a>, <a href="{ $url }"><b>Условия использования</b></a> и <a href="{ $url }"><b>Политику Конфиденциальности</b></a> нашего сервиса!
